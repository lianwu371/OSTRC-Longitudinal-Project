...
#%% seems to be working, implimenting lstm for unprocessed
...
test_df = df.drop("Participantsname",axis=1) #athlete name
test_df = df.drop("Recurrence",axis=1) #recurrence
y = test_df['Finalinjury']
X = test_df.drop(['Finalinjury'], axis = 1)
...
best.to_csv(r'C:\Users\Lian\OneDrive\Phase 4(With new data) - 27.03.2020\Script\Parameters\'LSTM_unprocessed.csv')
